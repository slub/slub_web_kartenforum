...
export const DynamicMapVisualization = (props) => {
  return (
    <div className="dyn-vis-control" title={translate("dynamicmapvis-open")}>
...
//   //
//   var dynamicMapVis_ = new vk2.tool.DynamicMapVisualization(
//     containerEl_,
//     feedbackEl_
//   );
...
//  * @private
//  */
// vk2.control.DynamicMapVisualization.prototype.createMenuEl_ = function (
//   parentEl,
//   contentEl,
//   dynamicMapVis
// ) {
//   var controlEl = goog.dom.createDom("a", {
//     innerHTML: "o",
//     class: "open-dyn-vis",
//   });
...
//         event.currentTarget.parentElement["title"] = vk2.utils.getMsg(
//           "dynamicmapvis-open"
//         );
//       } else {
...
//  * @private
//  */
// vk2.control.DynamicMapVisualization.prototype.createContentEl_ = function (
//   contentEl,
//   dynamicMapVis,
//   map
// ) {
...
//
//   // create start button
//   var startContainerEl = goog.dom.createDom("div", {
...
//   );
//
//   var tooltipStart = goog.dom.createDom("span", {
//     role: "tooltip",
//     innerHTML: vk2.utils.getMsg("dynamicmapvis-start"),
//   });
...
//
//   var tooltipStop = goog.dom.createDom("span", {
//     role: "tooltip",
//     innerHTML: vk2.utils.getMsg("dynamicmapvis-stop"),
//   });
