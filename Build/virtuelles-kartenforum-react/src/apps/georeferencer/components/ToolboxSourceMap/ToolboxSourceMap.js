...
import "./ToolboxSourceMap.scss";
export const ToolboxSourceMap = () => {
    ...
    const controls = [
        ...
        { id: "add-gcp", class: "add-gcp", title: translate("georef-setgcp") },
        {
            id: "move-gcp",
            class: "move-gcp",
            title: translate("georef-movegcp"),
        },
        { id: "del-gcp", class: "del-gcp", title: translate("georef-delgcp") },
        {
            id: "draw-clip",
            class: "draw-clip",
    ...
    return (
        <div className="vk-toolbox-source-map">
            <div
...
export default ToolboxSourceMap;
